...
public class SharedPrefConstants {
  ...
  public static final String FILE_NAME_APP_MAIN_PREF = "FlutterSharedPreferences";
    ...
    public static final String LAST_MSGID_FROM_INBOX = "LastMsgIdFromInbox";
    public static final String SUBSCRIBER_ID = "SubscriberId";
    public static final String LAST_MSGID_FROM_NOTIFICATION = "LastMsgIdFromNotification";
    public static final String DEVICE_MANUFACTURER_LIST = "DeviceManufacturerList";
    public static final String REPEAT_ALARM_TIME_IN_MINUTES = "RepeatAlarmTimeInMinutes";
